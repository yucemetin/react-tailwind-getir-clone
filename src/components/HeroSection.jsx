...
export default function HeroSection() {
    ...
    return (
        <div className='relative h-auto md:h-[500px] before:bg-gradient-to-r before:from-primary-brand-color before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10'>
            ...
            <div className='md:container flex items-center justify-between relative md:absolute top-0 left-o md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-20'>
                    ...
                    <div className='grid gap-y-3'>
                        <div className='flex gap-x-2'>
                            ...
                            <label className='flex-1 relative block'>
                                ...
                                <span className='w-full absolute top-0 left-0 h-full px-4 flex items-center text-sm text-gray-500 transition-all peer-focus:h-7 peer-focus:text-primary-brand-color peer-focus:text-xs  '>Telefon Numarası</span>
                            </label>
                        </div>
