  ...
  return (
    <>
      <div className='bg-brand-color'>
        <div className='container h-16 md:h-11 flex items-center justify-center md:justify-between'>
          <a href="#">
      ...
      <div className='container flex md:hidden items-center h-10 px-2 justify-between'>
