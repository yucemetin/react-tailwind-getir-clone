...
export default function MobileApp() {
  return (
    <div className='bg-primary-brand-color bg-mobile-app-background flex justify-between items-center mb-6 mx-40 rounded-lg text-white'>
      <div className='flex flex-col gap-y-3  p-10'>
        ...
        <nav className='mt-5 flex gap-x-2'>
          ...
          <a href="#" className='transition-all transform hover:scale-105'>
            <img src="https://getir.com/_next/static/images/huawei-appgallery-tr-4b890fa3167bc62f9069edaf45aa7f30.svg" alt="huawei" />
          </a>
        </nav>
      </div>
